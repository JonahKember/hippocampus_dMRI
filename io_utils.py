...
def get_paths(config, hemi):
    ...
    paths = {
        ...
        'T1':           config[f'hipp_crop_T1_{hemi}'],
        'subfields':    config[f'hipp_volume_{hemi}'],
        'midthickness': config[f'hipp_midthickness_{hemi}'],
        'inner':        config[f'hipp_inner_{hemi}'],
        'outer':        config[f'hipp_outer_{hemi}'],
